...
<p align="center">
  <img src="docs/assets/readme-desktop.png" alt="데스크톱과 작업 표시줄" style="max-width: 30%; border-radius: 8px;" />
  <br/>
  <em>데스크톱 바로가기와 시스템 모니터</em>
</p>

<p align="center">
  <img src="docs/assets/readme-tray-menu.png" alt="트레이 메뉴" style="max-width: 30%; border-radius: 8px;" />
  <br/>
  <em>트레이 우클릭 메뉴</em>
</p>
